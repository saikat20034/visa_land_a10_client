      ...
      <Typography>
        <label className="swap swap-rotate">
          ...
          <svg
            ...
            viewBox="0 0 24 24"
          >
            <path d="..." /> {/* You can paste your sun icon path here */}
          </svg>
          {/* Dark */}
          <svg
            ...
            viewBox="0 0 24 24"
          >
            <path d="..." /> {/* You can paste your moon icon path here */}
          </svg>
        </label>
      </Typography>
    </ul>
    ...
    <div className="sticky top-0 z-50 bg-blue-900">
      <Navbar className="max-w-full px-4 py-2 lg:px-8 lg:py-4 rounded-none shadow-md">
        <div className="flex items-center justify-between text-blue-gray-900">
          <Link to="/">
            <Typography className="mr-4 cursor-pointer py-1.5 font-semibold lg:font-bold text-xl md:text-2xl text-white font-lato">
              Visa<span className="text-red-500">L</span>and
            </Typography>
          </Link>
